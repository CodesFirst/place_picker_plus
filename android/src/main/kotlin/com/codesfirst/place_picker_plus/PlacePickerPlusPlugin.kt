package com.codesfirst.place_picker_plus
...
/** PlacePickerPlusPlugin */
class PlacePickerPlusPlugin: FlutterPlugin, MethodCallHandler, PluginRegistry.ActivityResultListener, ActivityAware {
  ...
  private val mFilterTypes = mapOf<String, TypeFilter>(
  ...
  override fun onAttachedToEngine(flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
    channel = MethodChannel(flutterPluginBinding.binaryMessenger, "place_picker_plus")
